...
import { 
  Sparkles, Building2, Users, Building, Mountain, ChevronLeft, ChevronRight,
  School, Castle
} from 'lucide-react';
import DashboardLayout from '@/components/layouts/DashboardLayout';
import { useSettingsStore } from '@/store/useSettingsStore';
import type { ContainedSetting } from '@/store/useSettingsStore';
...
export default function ContainedSettingsPage() {
  ...
  useEffect(() => {
    if (settingType !== 'contained') {
      router.push('/dashboard/novels/create/setting');
    }
  }, [settingType, router]);

  const handleSettingSelect = (title: ContainedSetting) => {
  ...
  const settingCategories: SettingCategory[] = [
    {
      icon: Building2,
      title: 'Architectural Complexes',
      description: 'Modern structures and facilities designed for specific purposes, from research centers to shopping malls',
      color: {
    ...
    },
    {
      ...
      description: 'Intimate social groups bound by shared purpose or lifestyle, creating tight-knit environments',
      color: {
    ...
    {
      icon: Building,
      title: 'Urban Microcosms',
      description: 'Self-contained districts within cities, each with its own distinct character and purpose',
      color: {
    ...
    },
    {
      ...
      description: 'Isolated locations far from civilization, perfect for focused and atmospheric storytelling',
      color: {
    ...
    },
    {
      ...
      description: 'Learning-focused spaces that foster growth, discovery, and interpersonal dynamics',
      color: {
    ...
    {
      icon: Castle,
      title: 'Historic Establishments',
      description: 'Time-honored places rich with tradition, heritage, and centuries of stories',
      color: {
          ...
          >
            <div className="text-center space-y-3">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                Select the type of contained environment that will shape your story's atmosphere and dynamics
              </p>
            </div>
